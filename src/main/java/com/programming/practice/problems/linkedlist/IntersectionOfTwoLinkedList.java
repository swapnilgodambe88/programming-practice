 ...
 * </pre>
 *
 * @see <a href = "https://leetcode.com/problems/intersection-of-two-linked-lists/">Intersection of
 *     Two Linked Lists</a>
 * @author Swapnil Godambe.<br>
 *     Copyright 2024.
 */
public final class IntersectionOfTwoLinkedList {
  public ListNode getIntersectionNode(final ListNode headA, final ListNode headB) {
    ...
    // NOTE: We are sure that the while loop will
